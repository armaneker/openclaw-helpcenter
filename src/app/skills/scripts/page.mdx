...
| | references/ | scripts/ |
|---|---|---|
| Content | Static text, documentation | Executable code |
| Loading | Read into context | Executed, output returned |
| Mutability | Rarely changes | Output varies by input |
| Use case | "Look up and apply" | "Run and get result" |
